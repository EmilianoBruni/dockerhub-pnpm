...
* [24.4.2, latest (main/Dockerfile)](https://github.com/EmilianoBruni/dockerhub-pnpm/blob/master/main/Dockerfile) (size: **200MB**)

* [24.4.2-ubuntu, ubuntu (ubuntu/Dockerfile)](https://github.com/EmilianoBruni/dockerhub-pnpm/blob/master/ubuntu/Dockerfile) (size: **741MB**) based on [ubuntu:24.04](https://hub.docker.com/repository/docker/ubuntu) 
