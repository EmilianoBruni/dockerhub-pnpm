...
* [24.4.3, latest (main/Dockerfile)](https://github.com/EmilianoBruni/dockerhub-pnpm/blob/master/main/Dockerfile) (size: **200MB**)

* [24.4.3-ubuntu, ubuntu (ubuntu/Dockerfile)](https://github.com/EmilianoBruni/dockerhub-pnpm/blob/master/ubuntu/Dockerfile) (size: **741MB**) based on [ubuntu:24.04](https://hub.docker.com/repository/docker/ubuntu) 
...
|:---|:---:|:---:|:---|
| EB | 2026-05-08 | 24.4.2 | Fix: bin path for pnpm |
| EB | 2026-05-08 | 24.4.1 | Fix: entrypoint not runnable in ubuntu |
